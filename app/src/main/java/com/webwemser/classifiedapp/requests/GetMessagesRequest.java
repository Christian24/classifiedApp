 ...
 * Broken server result
 */
@Deprecated
public class GetMessagesRequest extends Activity {
    ...
    public void start(final Context context, final SwipeRefreshLayout swipe) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException {
        ...
        Uri url = Helper.getUriBuilder().appendPath(login).appendPath("messages").appendQueryParameter("login", login)
